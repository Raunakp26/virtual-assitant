...
const geminiResponse = async (command, assistantName, userName) => {
    try {
      ...
      if (!baseUrl || !apiKey) {
        ...
        console.error("Base URL:", baseUrl ? "Set" : "Missing");
  ...
  
  {
    ...
    "userinput": "<original user input>" {only remove your name from userinput if exists} and agar kisi ne google ya youtube pe kuch search karne ko bola hai toh userInput me only bo search baala text jaye,
  ...
  `;
      ...
      console.error("Error input:", error.input);
      console.error("====================");
      throw error;
    }
  }
